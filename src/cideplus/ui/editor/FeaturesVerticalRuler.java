 ...
 * @since 2.0
 */
public class FeaturesVerticalRuler extends AbstractContributedRulerColumn implements IVerticalRulerColumn, IVerticalRulerInfo, IVerticalRulerInfoExtension {
	...
	private final static Object MODEL_ANNOTATION_MODEL = new Object();
	 ...
	 * @since 3.0
	 */
	public FeaturesVerticalRuler(IAnnotationModel model, int width, IAnnotationAccess annotationAccess) {
	 ...
	 * @since 3.0
	 */
	public FeaturesVerticalRuler(int width, IAnnotationAccess annotationAccess) {
		fWidth= width;
	 ...
	 * @param width the width of the vertical ruler
	 */
	public FeaturesVerticalRuler(IAnnotationModel model, int width) {
		fWidth= width;
		fAllowSetModel= false;
		fModel= model;
		fModel.addAnnotationModelListener(fInternalListener);
	 ...
	 * @param width the width of the vertical ruler
	 */
	public FeaturesVerticalRuler(int width) {
		fWidth= width;
	}

	public FeaturesVerticalRuler() {
	...
	public Control createControl(CompositeRuler parentRuler, Composite parentControl) {
		...
		fMouseListener= new MouseListener() {
			...
			public void mouseDown(MouseEvent event) {
				...
				if (1 == event.button)
					FeaturesVerticalRuler.this.mouseDown(lineNumber);
			}
	...
	protected boolean hasAnnotation(int lineNumber) {
		...
		if (fCachedTextViewer instanceof SourceViewer)
			model = ((SourceViewer) fCachedTextViewer).getAnnotationModel();
