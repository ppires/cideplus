...
public class FeatureColorCellEditor  extends DialogCellEditor {
     ...
     */
    public FeatureColorCellEditor(Composite parent) {
     ...
     * @since 2.1
     */
    public FeatureColorCellEditor(Composite parent, int style) {
        super(parent, style);
